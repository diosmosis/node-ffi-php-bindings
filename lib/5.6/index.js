...
exports.loadDependentSymbols = function () {
    ...
    _library._IO_marker = Struct({
        "_next": _library._IO_marker ? ref.refType(_library._IO_marker) : 'pointer',
        "_pos": 'int',
        "_sbuf": _library._IO_FILE ? ref.refType(_library._IO_FILE) : 'pointer'
    });
    
    _library._IO_FILE = Struct({
        "_IO_backup_base": ref.refType('char'),
        "_IO_buf_base": ref.refType('char'),
        "_IO_buf_end": ref.refType('char'),
        "_IO_read_base": ref.refType('char'),
        "_IO_read_end": ref.refType('char'),
        "_IO_read_ptr": ref.refType('char'),
        "_IO_save_base": ref.refType('char'),
        "_IO_save_end": ref.refType('char'),
        "_IO_write_base": ref.refType('char'),
        "_IO_write_end": ref.refType('char'),
        "_IO_write_ptr": ref.refType('char'),
        "__pad1": ref.refType('void'),
        "__pad2": ref.refType('void'),
        "__pad3": ref.refType('void'),
        "__pad4": ref.refType('void'),
        "__pad5": 'ulong',
        "_chain": _library._IO_FILE ? ref.refType(_library._IO_FILE) : 'pointer',
        "_cur_column": 'ushort',
        "_fileno": 'int',
        "_flags": 'int',
        "_flags2": 'int',
        "_lock": ref.refType('void'),
        "_markers": _library._IO_marker ? ref.refType(_library._IO_marker) : 'pointer',
        "_mode": 'int',
        "_offset": 'long',
        "_old_offset": 'long',
