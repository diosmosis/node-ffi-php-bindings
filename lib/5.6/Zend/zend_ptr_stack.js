...
_library._functions['zend_ptr_stack_3_push'] = _library.zend_ptr_stack_3_push;

_library.zend_ptr_stack_2_push = ['void', [ref.refType(_library.zend_ptr_stack), ref.refType('void'), ref.refType('void')]];
_library._functions['zend_ptr_stack_2_push'] = _library.zend_ptr_stack_2_push;
...
_library._functions['zend_ptr_stack_3_pop'] = _library.zend_ptr_stack_3_pop;
...
_library._functions['zend_ptr_stack_2_pop'] = _library.zend_ptr_stack_2_pop;

_library.zend_ptr_stack_push = ['void', [ref.refType(_library.zend_ptr_stack), ref.refType('void')]];
_library._functions['zend_ptr_stack_push'] = _library.zend_ptr_stack_push;

_library.zend_ptr_stack_pop = [ref.refType('void'), [ref.refType(_library.zend_ptr_stack)]];
_library._functions['zend_ptr_stack_pop'] = _library.zend_ptr_stack_pop;

_library.zend_ptr_stack_top = [ref.refType('void'), [ref.refType(_library.zend_ptr_stack)]];
_library._functions['zend_ptr_stack_top'] = _library.zend_ptr_stack_top;
