...
_library._temp_variable = Union({
    ...
    "fe": Struct({
        ...
        "ptr_ptr": _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer'
    }),
    "str_offset": Struct({
        "offset": 'uint',
        "ptr_ptr": _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer',
...
_library.zend_lookup_class = ['int', [ref.refType('char'), 'int', _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer') : 'pointer']];
_library._functions.push(_library.zend_lookup_class);

_library.zend_lookup_class_ex = ['int', [ref.refType('char'), 'int', _library.zend_literal ? ref.refType(_library.zend_literal) : 'pointer', 'int', _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer') : 'pointer']];
...
_library.zend_verify_arg_class_kind = [ref.refType('char'), [_library.zend_arg_info ? ref.refType(_library.zend_arg_info) : 'pointer', 'ulong', ref.refType(ref.refType('char')), _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
...
_library.zval_update_constant = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', 'uchar']];
_library._functions.push(_library.zval_update_constant);

_library.zval_update_constant_inline_change = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer']];
_library._functions.push(_library.zval_update_constant_inline_change);

_library.zval_update_constant_no_inline_change = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer']];
_library._functions.push(_library.zval_update_constant_no_inline_change);

_library.zval_update_constant_ex = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', 'uchar', _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer']];
...
_library.zend_vm_stack_get_arg_ex = [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', [_library.zend_execute_data ? ref.refType(_library.zend_execute_data) : 'pointer', 'int']];
...
_library.zend_vm_stack_get_arg = [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', ['int']];
...
_library.zend_fetch_dimension_by_zval = ['void', [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer']];
_library._functions.push(_library.zend_fetch_dimension_by_zval);

_library.zend_get_compiled_variable_value = [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', [_library.zend_execute_data ? ref.refType(_library.zend_execute_data) : 'pointer', 'uint']];
...
_library.zend_get_zval_ptr_ptr = [_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', ['int', _library.znode_op ? ref.refType(_library.znode_op) : 'pointer', _library.zend_execute_data ? ref.refType(_library.zend_execute_data) : 'pointer', _library.zend_free_op ? ref.refType(_library.zend_free_op) : 'pointer', 'int']];
