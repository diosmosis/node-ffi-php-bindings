...
_library._preload['_temp_variable'] = ['zend_class_entry', 'HashPointer', '_HashPointer', 'zval', 'pointer', 'pointer', 'zval', 'zval', '_zval_struct', 'zval', 'pointer', function () {
...
_library._preload['_zend_vm_stack'] = ['pointer', 'zend_vm_stack', 'pointer', function () {
