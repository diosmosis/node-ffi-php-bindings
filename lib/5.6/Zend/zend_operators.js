...
_library.is_numeric_string_ex = ['uchar', ['char' ? ref.refType('char') : 'pointer', 'int', 'long' ? ref.refType('long') : 'pointer', 'double' ? ref.refType('double') : 'pointer', 'int', 'int' ? ref.refType('int') : 'pointer']];
_library._functions.push(_library.is_numeric_string_ex);

_library.is_numeric_string = ['uchar', ['char' ? ref.refType('char') : 'pointer', 'int', 'long' ? ref.refType('long') : 'pointer', 'double' ? ref.refType('double') : 'pointer', 'int']];
_library._functions.push(_library.is_numeric_string);

_library.zend_memnstr = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'int', 'char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.zend_memnstr);

_library.zend_memrchr = ['void' ? ref.refType('void') : 'pointer', ['void' ? ref.refType('void') : 'pointer', 'int', 'ulong']];
...
_library._convert_to_cstring = ['void', [ref.refType(_library.zval), 'char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library._convert_to_cstring);

_library._convert_to_string = ['void', [ref.refType(_library.zval), 'char' ? ref.refType('char') : 'pointer', 'uint']];
...
_library.zend_string_to_double = ['double', ['char' ? ref.refType('char') : 'pointer', 'uint']];
...
_library.zend_str_tolower = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_str_tolower);

_library.zend_str_tolower_copy = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_str_tolower_copy);

_library.zend_str_tolower_dup = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer', 'uint']];
...
_library.zend_binary_strcmp = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_binary_strcmp);

_library.zend_binary_strncmp = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint', 'uint']];
_library._functions.push(_library.zend_binary_strncmp);

_library.zend_binary_strcasecmp = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_binary_strcasecmp);

_library.zend_binary_strncasecmp = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint', 'uint']];
_library._functions.push(_library.zend_binary_strncasecmp);

_library.zend_binary_strncasecmp_l = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint', 'uint']];
...
_library.zend_atoi = ['int', ['char' ? ref.refType('char') : 'pointer', 'int']];
_library._functions.push(_library.zend_atoi);

_library.zend_atol = ['long', ['char' ? ref.refType('char') : 'pointer', 'int']];
_library._functions.push(_library.zend_atol);

_library.zend_locale_sprintf_double = ['void', [ref.refType(_library.zval), 'char' ? ref.refType('char') : 'pointer', 'uint']];
