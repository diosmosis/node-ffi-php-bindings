...
_library.zval_copy_static_var = ['int', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), 'int', ref.refType('void'), _library.zend_hash_key ? ref.refType(_library.zend_hash_key) : 'pointer']];
...
_library._zval_ptr_dtor = ['void', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), ref.refType('char'), 'uint']];
...
_library._zval_internal_ptr_dtor = ['void', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), ref.refType('char'), 'uint']];
...
_library._zval_ptr_dtor_wrapper = ['void', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer')]];
...
_library._zval_internal_ptr_dtor_wrapper = ['void', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer')]];
_library._functions.push(_library._zval_internal_ptr_dtor_wrapper);

_library.zval_add_ref = ['void', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer')]];
