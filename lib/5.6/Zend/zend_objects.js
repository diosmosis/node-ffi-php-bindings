...
_library.zend_objects_new = [_library.zend_object_value, [ref.refType(_library.zend_object ? ref.refType(_library.zend_object) : 'pointer'), _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer']];
