...
_library.zend_object_call_method_t = ffi.Function('int', ['char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library._zval_struct), ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer', ref.refType(_library._zval_struct), 'int']);
...
_library.zend_object_count_elements_t = ffi.Function('int', [ref.refType(_library._zval_struct), 'long' ? ref.refType('long') : 'pointer']);
...
_library.zend_object_get_class_name_t = ffi.Function('int', [ref.refType(_library._zval_struct), 'char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'uint' ? ref.refType('uint') : 'pointer', 'int']);

_library.zend_object_get_closure_t = ffi.Function('int', [ref.refType(_library._zval_struct), ref.refType(_library._zend_class_entry) ? ref.refType(ref.refType(_library._zend_class_entry)) : 'pointer', ref.refType(_library._zend_function) ? ref.refType(ref.refType(_library._zend_function)) : 'pointer', ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer']);
...
_library.zend_object_get_debug_info_t = ffi.Function(ref.refType(_library._hashtable), [ref.refType(_library._zval_struct), 'int' ? ref.refType('int') : 'pointer']);

_library.zend_object_get_gc_t = ffi.Function(ref.refType(_library._hashtable), [ref.refType(_library._zval_struct), ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer' ? ref.refType(ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer') : 'pointer', 'int' ? ref.refType('int') : 'pointer']);

_library.zend_object_get_method_t = ffi.Function(ref.refType(_library._zend_function), [ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library._zend_literal)]);

_library.zend_object_get_properties_t = ffi.Function(ref.refType(_library._hashtable), [ref.refType(_library._zval_struct)]);

_library.zend_object_get_property_ptr_ptr_t = ffi.Function(ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer', [ref.refType(_library._zval_struct), ref.refType(_library._zval_struct), 'int', ref.refType(_library._zend_literal)]);
...
_library.zend_object_set_t = ffi.Function('void', [ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer', ref.refType(_library._zval_struct)]);
...
_library.zend_std_get_static_method = [ref.refType(_library._zend_function), [ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library._zend_literal)]];
_library._functions.push(_library.zend_std_get_static_method);

_library.zend_std_get_static_property = [ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', [ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'int', 'uchar', ref.refType(_library._zend_literal)]];
_library._functions.push(_library.zend_std_get_static_property);

_library.zend_std_unset_static_property = ['uchar', [ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library._zend_literal)]];
...
_library.zend_std_get_debug_info = [ref.refType(_library.HashTable), [ref.refType(_library.zval), 'int' ? ref.refType('int') : 'pointer']];
...
_library.zend_check_private = ['int', [ref.refType(_library._zend_function), ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'int']];
...
_library.zend_check_property_access = ['int', [ref.refType(_library.zend_object), 'char' ? ref.refType('char') : 'pointer', 'int']];
_library._functions.push(_library.zend_check_property_access);

_library.zend_std_call_user_call = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
