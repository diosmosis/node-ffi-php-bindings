...
_library._preload['_zend_object_handlers'] = ['zend_object_add_ref_t', 'zend_object_call_method_t', 'zend_object_cast_t', 'zend_object_clone_obj_t', 'zend_object_compare_zvals_t', 'zend_object_compare_t', 'zend_object_count_elements_t', 'zend_object_del_ref_t', 'zend_object_do_operation_t', 'zend_object_get_t', 'zend_object_get_class_entry_t', 'zend_object_get_class_name_t', 'zend_object_get_closure_t', 'zend_object_get_constructor_t', 'zend_object_get_debug_info_t', 'zend_object_get_gc_t', 'zend_object_get_method_t', 'zend_object_get_properties_t', 'zend_object_get_property_ptr_ptr_t', 'zend_object_has_dimension_t', 'zend_object_has_property_t', 'zend_object_read_dimension_t', 'zend_object_read_property_t', 'zend_object_set_t', 'zend_object_unset_dimension_t', 'zend_object_unset_property_t', 'zend_object_write_dimension_t', 'zend_object_write_property_t', function () {
