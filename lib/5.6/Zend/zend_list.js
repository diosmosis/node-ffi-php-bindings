...
_library.rsrc_dtor_func_t = ffi.Function('void', [_library._zend_rsrc_list_entry ? ref.refType(_library._zend_rsrc_list_entry) : 'pointer']);
...
_library.zend_destroy_rsrc_list = ['void', [_library.HashTable ? ref.refType(_library.HashTable) : 'pointer']];
...
_library.zend_register_resource = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer', ref.refType('void'), 'int']];
