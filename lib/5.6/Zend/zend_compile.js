...
_library._zend_execute_data = Struct({
    ...
    "original_return_value": _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer',
...
_library.zend_cleanup_class_data = ['int', [_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
_library._functions.push(_library.zend_cleanup_class_data);

_library.zend_cleanup_user_class_data = ['int', [_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
...
_library.clean_non_persistent_class_full = ['int', [_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
...
_library.destroy_zend_class = ['void', [_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
_library._functions.push(_library.destroy_zend_class);

_library.zend_class_add_ref = ['void', [_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer' ? ref.refType(_library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer') : 'pointer']];
