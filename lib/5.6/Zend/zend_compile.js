...
_library._zend_internal_function = Struct({
    ...
    "fn_flags": 'uint',
    "function_name": 'char' ? ref.refType('char') : 'pointer',
...
_library._zend_function_state = Struct({
    "arguments": 'void' ? ref.refType('void') : 'pointer' ? ref.refType('void' ? ref.refType('void') : 'pointer') : 'pointer',
...
_library._zend_execute_data = Struct({
    ...
    "original_return_value": ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer',
...
_library._zend_op_array = Struct({
    ...
    "prototype": ref.refType(_library._zend_function),
    "refcount": 'uint' ? ref.refType('uint') : 'pointer',
    "required_num_args": 'uint',
    "reserved": RefArray('void' ? ref.refType('void') : 'pointer', 4),
    "run_time_cache": 'void' ? ref.refType('void') : 'pointer' ? ref.refType('void' ? ref.refType('void') : 'pointer') : 'pointer',
    "scope": ref.refType(_library.zend_class_entry),
...
_library.zend_visibility_string = ['char' ? ref.refType('char') : 'pointer', ['uint']];
...
_library._zend_internal_function_info = Struct({
    "_allow_null": 'uchar',
    "_class_name": 'char' ? ref.refType('char') : 'pointer',
    "_is_variadic": 'uchar',
    "_name": 'char' ? ref.refType('char') : 'pointer',
    "_name_len": 'uint',
    "_type_hint": 'uchar',
    "required_num_args": 'uint',
...
_library.zend_set_compiled_filename = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.zend_set_compiled_filename);

_library.zend_restore_compiled_filename = ['void', ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.zend_restore_compiled_filename);

_library.zend_get_compiled_filename = ['char' ? ref.refType('char') : 'pointer', []];
...
_library.zend_resolve_non_class_name = ['void', [ref.refType(_library.znode), 'uchar' ? ref.refType('uchar') : 'pointer', 'uchar', ref.refType(_library.HashTable)]];
_library._functions.push(_library.zend_resolve_non_class_name);

_library.zend_resolve_function_name = ['void', [ref.refType(_library.znode), 'uchar' ? ref.refType('uchar') : 'pointer']];
_library._functions.push(_library.zend_resolve_function_name);

_library.zend_resolve_const_name = ['void', [ref.refType(_library.znode), 'uchar' ? ref.refType('uchar') : 'pointer']];
...
_library.zend_get_compiled_variable_name = ['char' ? ref.refType('char') : 'pointer', [ref.refType(_library.zend_op_array), 'uint', 'int' ? ref.refType('int') : 'pointer']];
...
_library.zend_init_list = ['void', ['void' ? ref.refType('void') : 'pointer', 'void' ? ref.refType('void') : 'pointer']];
_library._functions.push(_library.zend_init_list);

_library.zend_add_to_list = ['void', ['void' ? ref.refType('void') : 'pointer', 'void' ? ref.refType('void') : 'pointer']];
...
_library.compile_string = [ref.refType(_library.zend_op_array), [ref.refType(_library.zval), 'char' ? ref.refType('char') : 'pointer']];
...
_library.zend_cleanup_class_data = ['int', [ref.refType(_library.zend_class_entry) ? ref.refType(ref.refType(_library.zend_class_entry)) : 'pointer']];
_library._functions.push(_library.zend_cleanup_class_data);

_library.zend_cleanup_user_class_data = ['int', [ref.refType(_library.zend_class_entry) ? ref.refType(ref.refType(_library.zend_class_entry)) : 'pointer']];
...
_library.clean_non_persistent_class_full = ['int', [ref.refType(_library.zend_class_entry) ? ref.refType(ref.refType(_library.zend_class_entry)) : 'pointer']];
...
_library.destroy_zend_class = ['void', [ref.refType(_library.zend_class_entry) ? ref.refType(ref.refType(_library.zend_class_entry)) : 'pointer']];
_library._functions.push(_library.destroy_zend_class);

_library.zend_class_add_ref = ['void', [ref.refType(_library.zend_class_entry) ? ref.refType(ref.refType(_library.zend_class_entry)) : 'pointer']];
_library._functions.push(_library.zend_class_add_ref);

_library.zend_mangle_property_name = ['void', ['char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'int' ? ref.refType('int') : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'int', 'char' ? ref.refType('char') : 'pointer', 'int', 'int']];
_library._functions.push(_library.zend_mangle_property_name);

_library.zend_unmangle_property_name_ex = ['int', ['char' ? ref.refType('char') : 'pointer', 'int', 'char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'int' ? ref.refType('int') : 'pointer']];
...
_library.zend_make_compiled_string_description = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer']];
...
_library.zend_get_class_fetch_type = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_get_class_fetch_type);

_library.zend_auto_global_callback = ffi.Function('uchar', ['char' ? ref.refType('char') : 'pointer', 'uint']);
...
_library.zend_register_auto_global = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', 'uchar', _library.zend_auto_global_callback]];
...
_library.zend_is_auto_global = ['uchar', ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.zend_is_auto_global);

_library.zend_is_auto_global_quick = ['uchar', ['char' ? ref.refType('char') : 'pointer', 'uint', 'ulong']];
_library._functions.push(_library.zend_is_auto_global_quick);

_library.zend_dirname = ['ulong', ['char' ? ref.refType('char') : 'pointer', 'ulong']];
