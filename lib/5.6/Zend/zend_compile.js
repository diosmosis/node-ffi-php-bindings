...
_library._preload['_zend_function_state'] = ['zend_function', 'pointer', function () {
...
_library._preload['_call_slot'] = ['zend_function', 'zval', 'zend_class_entry', function () {
...
_library._preload['_zend_execute_data'] = ['_zend_op', 'zend_function_state', '_zend_function_state', 'zend_op_array', 'zval', 'HashTable', '_zend_execute_data', 'zval', 'pointer', 'zend_class_entry', 'zend_class_entry', 'zval', '_zend_op', 'zval', 'call_slot', 'call_slot', function () {
...
_library._preload['_znode_op'] = ['zend_op', 'zval', 'zend_literal', function () {
...
_library._preload['_zend_op_array'] = ['zend_class_entry', '_zend_function', 'zend_arg_info', 'zend_op', 'zend_compiled_variable', 'zend_brk_cont_element', 'zend_try_catch_element', 'HashTable', 'zend_literal', 'pointer', 'pointer', function () {
...
_library._preload['_zend_internal_function'] = ['zend_class_entry', '_zend_function', 'zend_arg_info', 'void (int, zval *, zval **, zval *, int)', '_zend_module_entry', function () {
...
_library._preload['_zend_function'] = ['zend_class_entry', '_zend_function', 'zend_arg_info', 'zend_op_array', 'zend_internal_function', '_zend_internal_function', function () {
...
_library._preload['_znode'] = ['znode_op', '_znode_op', 'zval', '_zval_struct', 'zend_op_array', 'zend_ast', function () {
...
_library._preload['_list_llist_element'] = ['znode', '_znode', 'zend_llist', '_zend_llist', 'znode', '_znode', function () {
