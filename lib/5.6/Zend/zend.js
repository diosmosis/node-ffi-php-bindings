...
_library._preload['_zend_trait_precedence'] = ['pointer', 'zend_trait_method_reference', function () {
...
_library._preload['_zend_class_entry'] = ['_zend_function', '_zend_function', '_zend_function', '_zend_function', '_zend_function', '_zend_function', '_zend_function', '_zend_function', '_zend_function', 'HashTable', '_hashtable', '_zend_function', 'zend_object_value (zend_class_entry *)', 'pointer', 'pointer', '_zend_function', 'HashTable', '_hashtable', 'zend_object_iterator *(zend_class_entry *, zval *, int)', '_zend_function *(zend_class_entry *, char *, int)', '_zend_function_entry', '_zend_module_entry', 'int (zend_class_entry *, zend_class_entry *)', 'pointer', 'zend_class_iterator_funcs', '_zend_class_iterator_funcs', '_zend_class_entry', 'HashTable', '_hashtable', 'int (zval *, unsigned char **, zend_uint *, zend_serialize_data *)', '_zend_function', 'pointer', 'pointer', 'pointer', 'pointer', 'int (zval **, zend_class_entry *, const unsigned char *, zend_uint, zend_unserialize_data *)', '_zend_function', function () {
...
_library._preload['_zvalue_value'] = ['zend_ast', 'HashTable', 'zend_object_value', '_zend_object_value', function () {
...
_library._preload['_zend_object'] = ['zend_class_entry', 'HashTable', 'HashTable', 'pointer', function () {
...
_library._preload['_zend_utility_functions'] = ['void (void)', 'void (int, const char *, const uint, const char *, __va_list_tag *)', 'FILE *(const char *, char **)', 'int (const char *, uint, zval *)', 'char *(char *, size_t)', 'void (long, const void *)', 'void (int)', 'int (const char *, ...)', 'char *(const char *, int)', 'int (const char *, zend_file_handle *)', 'void (int)', 'void (void)', 'int (char **, size_t, const char *, __va_list_tag *)', 'int (const char *, uint)', function () {
...
_library._preload['zend_error_handling'] = ['zend_class_entry', 'zend_error_handling_t', 'zval', function () {
