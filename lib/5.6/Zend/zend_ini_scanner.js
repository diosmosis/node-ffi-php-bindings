...
_library.zend_ini_scanner_get_filename = ['char' ? ref.refType('char') : 'pointer', []];
...
_library.zend_ini_prepare_string_for_scanning = ['int', ['char' ? ref.refType('char') : 'pointer', 'int']];
