...
_library.zend_call_method = [_library.zval ? ref.refType(_library.zval) : 'pointer', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer', ref.refType(_library.zend_function ? ref.refType(_library.zend_function) : 'pointer'), ref.refType('char'), 'int', ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), 'int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer']];
...
_library.zend_user_it_get_current_data = ['void', [_library.zend_object_iterator ? ref.refType(_library.zend_object_iterator) : 'pointer', ref.refType(ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'))]];
...
_library.zend_user_unserialize = ['int', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer', ref.refType('uchar'), 'uint', _library.zend_unserialize_data ? ref.refType(_library.zend_unserialize_data) : 'pointer']];
...
_library.zend_class_unserialize_deny = ['int', [ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'), _library.zend_class_entry ? ref.refType(_library.zend_class_entry) : 'pointer', ref.refType('uchar'), 'uint', _library.zend_unserialize_data ? ref.refType(_library.zend_unserialize_data) : 'pointer']];
