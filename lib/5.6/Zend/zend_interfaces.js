...
_library.zend_call_method = [ref.refType(_library.zval), [ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zend_class_entry), ref.refType(_library.zend_function) ? ref.refType(ref.refType(_library.zend_function)) : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', 'int', ref.refType(_library.zval), ref.refType(_library.zval)]];
...
_library.zend_user_it_get_current_data = ['void', [ref.refType(_library.zend_object_iterator), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer' ? ref.refType(ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer') : 'pointer']];
...
_library.zend_user_serialize = ['int', [ref.refType(_library.zval), 'uchar' ? ref.refType('uchar') : 'pointer' ? ref.refType('uchar' ? ref.refType('uchar') : 'pointer') : 'pointer', 'uint' ? ref.refType('uint') : 'pointer', ref.refType(_library.zend_serialize_data)]];
_library._functions.push(_library.zend_user_serialize);

_library.zend_user_unserialize = ['int', [ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zend_class_entry), 'uchar' ? ref.refType('uchar') : 'pointer', 'uint', ref.refType(_library.zend_unserialize_data)]];
_library._functions.push(_library.zend_user_unserialize);

_library.zend_class_serialize_deny = ['int', [ref.refType(_library.zval), 'uchar' ? ref.refType('uchar') : 'pointer' ? ref.refType('uchar' ? ref.refType('uchar') : 'pointer') : 'pointer', 'uint' ? ref.refType('uint') : 'pointer', ref.refType(_library.zend_serialize_data)]];
_library._functions.push(_library.zend_class_serialize_deny);

_library.zend_class_unserialize_deny = ['int', [ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zend_class_entry), 'uchar' ? ref.refType('uchar') : 'pointer', 'uint', ref.refType(_library.zend_unserialize_data)]];
