...
_library._zend_function_entry = Struct({
    ...
    "handler": ffi.Function('void', ['int', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer' ? ref.refType(_library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer') : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', 'int']),
    "num_args": 'uint'
});
...
_library._zend_fcall_info = Struct({
    ...
    "param_count": 'uint',
    "params": _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer',
    "retval_ptr_ptr": _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer',
    "size": 'ulong',
...
_library._zend_get_parameters_array = ['int', ['int', 'int', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer']];
_library._functions.push(_library._zend_get_parameters_array);

_library._zend_get_parameters_array_ex = ['int', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer']];
...
_library.add_assoc_function = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer', ref.refType('char'), ffi.Function('void', ['int', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer' ? ref.refType(_library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer') : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', 'int'])]];
...
_library.call_user_function = ['int', [_library.HashTable ? ref.refType(_library.HashTable) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'uint', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer']];
_library._functions.push(_library.call_user_function);

_library.call_user_function_ex = ['int', [_library.HashTable ? ref.refType(_library.HashTable) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', 'uint', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer', 'int', _library.HashTable ? ref.refType(_library.HashTable) : 'pointer']];
...
_library.zend_fcall_info_args_save = ['void', [_library.zend_fcall_info ? ref.refType(_library.zend_fcall_info) : 'pointer', ref.refType('int'), _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer') : 'pointer']];
_library._functions.push(_library.zend_fcall_info_args_save);

_library.zend_fcall_info_args_restore = ['void', [_library.zend_fcall_info ? ref.refType(_library.zend_fcall_info) : 'pointer', 'int', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer']];
...
_library.zend_fcall_info_argp = ['int', [_library.zend_fcall_info ? ref.refType(_library.zend_fcall_info) : 'pointer', 'int', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer') : 'pointer']];
...
_library.zend_fcall_info_call = ['int', [_library.zend_fcall_info ? ref.refType(_library.zend_fcall_info) : 'pointer', _library.zend_fcall_info_cache ? ref.refType(_library.zend_fcall_info_cache) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer']];
...
_library.zif_display_disabled_function = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_display_disabled_function);

_library.zif_display_disabled_class = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
