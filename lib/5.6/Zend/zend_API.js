...
_library._preload['_zend_function_entry'] = ['void (int, zval *, zval **, zval *, int)', '_zend_arg_info', function () {
...
_library._preload['_zend_fcall_info'] = ['HashTable', 'zval', 'HashTable', 'pointer', 'pointer', 'zval', function () {
...
_library._preload['_zend_fcall_info_cache'] = ['zend_function', 'zend_class_entry', 'zend_class_entry', 'zval', function () {
