...
_library._preload['_zend_mm_mem_handlers'] = ['zend_mm_storage *(void *)', 'void (zend_mm_storage *)', 'void (zend_mm_storage *)', 'zend_mm_segment *(zend_mm_storage *, size_t)', 'zend_mm_segment *(zend_mm_storage *, zend_mm_segment *, size_t)', 'void (zend_mm_storage *, zend_mm_segment *)', function () {
