...
_library.verify_path_func = ffi.Function('int', [_library._cwd_state ? ref.refType(_library._cwd_state) : 'pointer']);
...
_library.virtual_fopen = [_library.FILE ? ref.refType(_library.FILE) : 'pointer', [ref.refType('char'), ref.refType('char')]];
...
_library.virtual_stat = ['int', [ref.refType('char'), _library.stat ? ref.refType(_library.stat) : 'pointer']];
_library._functions.push(_library.virtual_stat);

_library.virtual_lstat = ['int', [ref.refType('char'), _library.stat ? ref.refType(_library.stat) : 'pointer']];
...
_library.virtual_opendir = [_library.DIR ? ref.refType(_library.DIR) : 'pointer', [ref.refType('char')]];
_library._functions.push(_library.virtual_opendir);

_library.virtual_popen = [_library.FILE ? ref.refType(_library.FILE) : 'pointer', [ref.refType('char'), ref.refType('char')]];
...
_library.virtual_utime = ['int', [ref.refType('char'), _library.utimbuf ? ref.refType(_library.utimbuf) : 'pointer']];
...
_library.virtual_file_ex = ['int', [_library.cwd_state ? ref.refType(_library.cwd_state) : 'pointer', ref.refType('char'), _library.verify_path_func, 'int']];
...
_library._realpath_cache_bucket = Struct({
    ...
    "is_dir": 'int',
    "key": 'ulong',
    "next": _library._realpath_cache_bucket ? ref.refType(_library._realpath_cache_bucket) : 'pointer',
...
_library._virtual_cwd_globals = Struct({
    ...
    "realpath_cache": RefArray(_library.realpath_cache_bucket ? ref.refType(_library.realpath_cache_bucket) : 'pointer', 1024),
...
_library.realpath_cache_lookup = [_library.realpath_cache_bucket ? ref.refType(_library.realpath_cache_bucket) : 'pointer', [ref.refType('char'), 'int', _library.time_t]];
...
_library.realpath_cache_get_buckets = [_library.realpath_cache_bucket ? ref.refType(_library.realpath_cache_bucket) : 'pointer' ? ref.refType(_library.realpath_cache_bucket ? ref.refType(_library.realpath_cache_bucket) : 'pointer') : 'pointer', []];
