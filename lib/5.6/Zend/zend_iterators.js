...
_library._zend_object_iterator_funcs = Struct({
    ...
    "get_current_data": ffi.Function('void', [_library._zend_object_iterator ? ref.refType(_library._zend_object_iterator) : 'pointer', ref.refType(ref.refType(_library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer'))]),
...
_library.zend_iterator_unwrap = ['int32', [_library.zval ? ref.refType(_library.zval) : 'pointer', ref.refType(_library.zend_object_iterator ? ref.refType(_library.zend_object_iterator) : 'pointer')]];
