...
_library._zend_object_iterator_funcs = Struct({
    ...
    "get_current_data": ffi.Function('void', [ref.refType(_library._zend_object_iterator), ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer' ? ref.refType(ref.refType(_library._zval_struct) ? ref.refType(ref.refType(_library._zval_struct)) : 'pointer') : 'pointer']),
...
_library.zend_iterator_unwrap = ['int32', [ref.refType(_library.zval), ref.refType(_library.zend_object_iterator) ? ref.refType(ref.refType(_library.zend_object_iterator)) : 'pointer']];
