...
_library._preload['_zend_module_entry'] = ['_zend_module_dep', '_zend_function_entry', 'void (void *)', 'void (void *)', 'void (zend_module_entry *)', '_zend_ini_entry', 'int (int, int)', 'int (int, int)', 'int (void)', 'int (int, int)', 'int (int, int)', function () {
