...
_library._preload['_zend_declarables'] = ['zval', '_zval_struct', function () {
    _library._zend_declarables.size = 0;
    _library._zend_declarables.defineProperty("ticks", _library.zval);
}];

_library._preload['zend_declarables'] = [function () {
...
_library._preload['_zend_compiler_globals'] = ['zend_class_entry', 'zend_op_array', 'HashTable', 'zend_stack', '_zend_stack', 'HashTable', 'HashTable', '_hashtable', 'zend_compiler_context', '_zend_compiler_context', 'zend_stack', '_zend_stack', 'HashTable', 'HashTable', 'HashTable', 'zval', 'zend_declarables', '_zend_declarables', 'zend_stack', '_zend_stack', 'zend_llist', '_zend_llist', 'HashTable', '_hashtable', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'HashTable', 'znode', '_znode', '_zend_ini_parser_param', 'HashTable', '_hashtable', 'zend_llist', '_zend_llist', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_llist', '_zend_llist', 'pointer', 'zend_stack', '_zend_stack', function () {
...
_library._preload['zend_vm_stack'] = [function () {
    _library.zend_vm_stack = ref.refType(_library._zend_vm_stack);
}];

_library._preload['zend_ini_entry'] = [function () {
...
_library._preload['_zend_executor_globals'] = ['zval', 'zend_op_array', 'HashTable', 'zend_vm_stack', 'zend_function', 'jmp_buf', 'zend_class_entry', 'HashTable', '_zend_execute_data', '_zend_module_entry', 'zend_error_handling_t', 'zend_ini_entry', 'zval', '_zval_struct', 'zval', 'zval', 'zend_class_entry', 'zend_op', 'HashTable', 'HashTable', 'HashTable', '_hashtable', 'HashTable', 'HashTable', 'zend_objects_store', '_zend_objects_store', 'zend_op', 'pointer', 'HashTable', '_hashtable', 'zval', 'HashTable', '_hashtable', 'pointer', 'pointer', 'zend_class_entry', 'zend_op', 'zend_property_info', '_zend_property_info', 'HashTable', '_hashtable', 'pointer', 'pointer', 'pointer', 'zval', '_zval_struct', 'zval', 'zval', 'zend_ptr_stack', '_zend_ptr_stack', 'zend_stack', '_zend_stack', 'zval', 'zend_ptr_stack', '_zend_ptr_stack', 'HashTable', function () {
    ...
    _library._zend_executor_globals.defineProperty("exception_op", _library.__RefArray(_library.zend_op, 3));
    ...
    _library._zend_executor_globals.defineProperty("reserved", _library.__RefArray(ref.refType('void'), 4));
    ...
    _library._zend_executor_globals.defineProperty("symtable_cache", _library.__RefArray(ref.refType(_library.HashTable), 32));
...
_library._preload['_zend_php_scanner_globals'] = ['zend_ptr_stack', '_zend_ptr_stack', 'zend_encoding_filter', 'zend_encoding_filter', 'zend_encoding', 'zend_stack', '_zend_stack', 'zend_file_handle', 'zend_file_handle', function () {
...
_library._preload['_zend_ini_scanner_globals'] = ['zend_stack', '_zend_stack', 'zend_file_handle', 'zend_file_handle', function () {
