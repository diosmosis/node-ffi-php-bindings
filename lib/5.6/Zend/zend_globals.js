...
_library._preload['_zend_compiler_globals'] = ['zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_class_entry', 'zend_llist', '_zend_llist', 'zend_llist', '_zend_llist', 'zend_stack', '_zend_stack', 'zend_stack', '_zend_stack', 'zend_op_array', 'HashTable', 'HashTable', 'HashTable', '_hashtable', 'HashTable', 'zend_declarables', '_zend_declarables', 'zend_llist', '_zend_llist', '_zend_ini_parser_param', 'znode', '_znode', 'zval', 'HashTable', 'HashTable', 'HashTable', 'HashTable', '_hashtable', 'zend_compiler_context', '_zend_compiler_context', 'zend_stack', '_zend_stack', 'HashTable', '_hashtable', 'pointer', function () {
...
_library._preload['_zend_executor_globals'] = ['pointer', 'zval', '_zval_struct', 'zval', 'zval', '_zval_struct', 'zval', 'pointer', 'pointer', 'pointer', 'pointer', 'HashTable', 'HashTable', '_hashtable', 'HashTable', '_hashtable', 'jmp_buf', 'zend_op_array', 'HashTable', 'HashTable', 'HashTable', 'zend_class_entry', 'zend_class_entry', 'zval', 'HashTable', 'zend_function', 'HashTable', '_hashtable', 'HashTable', '_hashtable', 'zend_vm_stack', 'zval', 'zval', 'zend_stack', '_zend_stack', 'zend_ptr_stack', '_zend_ptr_stack', 'zend_ptr_stack', '_zend_ptr_stack', 'zend_error_handling_t', 'zend_class_entry', 'HashTable', 'HashTable', 'zend_ini_entry', 'zend_objects_store', '_zend_objects_store', 'zval', 'zval', 'zend_op', 'zend_op', '_zend_execute_data', '_zend_module_entry', 'zend_property_info', '_zend_property_info', 'zend_op', 'pointer', function () {
...
_library._preload['_zend_php_scanner_globals'] = ['zend_file_handle', 'zend_file_handle', 'zend_stack', '_zend_stack', 'zend_ptr_stack', '_zend_ptr_stack', 'zend_encoding_filter', 'zend_encoding_filter', 'zend_encoding', function () {
...
_library._preload['_zend_ini_scanner_globals'] = ['zend_file_handle', 'zend_file_handle', 'zend_stack', '_zend_stack', function () {
