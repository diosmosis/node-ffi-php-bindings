...
_library._zend_compiler_globals = Struct({
    ...
    "compiled_filename": 'char' ? ref.refType('char') : 'pointer',
    ...
    "interactive": 'int',
    "interned_empty_string": 'char' ? ref.refType('char') : 'pointer',
    "interned_strings": _library.HashTable,
    "interned_strings_end": 'char' ? ref.refType('char') : 'pointer',
    "interned_strings_snapshot_top": 'char' ? ref.refType('char') : 'pointer',
    "interned_strings_start": 'char' ? ref.refType('char') : 'pointer',
    "interned_strings_top": 'char' ? ref.refType('char') : 'pointer',
    ...
    "parse_error": 'uchar',
    "script_encoding_list": ref.refType(_library.zend_encoding) ? ref.refType(ref.refType(_library.zend_encoding)) : 'pointer',
...
_library._zend_executor_globals = Struct({
    ...
    "opline_ptr": ref.refType(_library.zend_op) ? ref.refType(ref.refType(_library.zend_op)) : 'pointer',
    ...
    "return_value_ptr_ptr": ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer',
    "saved_fpu_cw": 'ushort',
    "saved_fpu_cw_ptr": 'void' ? ref.refType('void') : 'pointer',
    ...
    "symtable_cache_limit": ref.refType(_library.HashTable) ? ref.refType(ref.refType(_library.HashTable)) : 'pointer',
    "symtable_cache_ptr": ref.refType(_library.HashTable) ? ref.refType(ref.refType(_library.HashTable)) : 'pointer',
    "ticks_count": 'int',
    "timeout_seconds": 'int',
