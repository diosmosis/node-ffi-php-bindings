...
_library._zend_compiler_globals = Struct({
    ...
    "parse_error": 'uchar',
    "script_encoding_list": ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer'),
...
_library._zend_executor_globals = Struct({
    ...
    "opline_ptr": ref.refType(_library.zend_op ? ref.refType(_library.zend_op) : 'pointer'),
    ...
    "return_value_ptr_ptr": ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'),
    "saved_fpu_cw": 'ushort',
    ...
    "symtable_cache_limit": ref.refType(_library.HashTable ? ref.refType(_library.HashTable) : 'pointer'),
    "symtable_cache_ptr": ref.refType(_library.HashTable ? ref.refType(_library.HashTable) : 'pointer'),
    "ticks_count": 'int',
    "timeout_seconds": 'int',
