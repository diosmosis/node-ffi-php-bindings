...
_library._zend_ini_entry = Struct({
    "displayer": ffi.Function('void', [_library._zend_ini_entry ? ref.refType(_library._zend_ini_entry) : 'pointer', 'int']),
    ...
    "name_length": 'uint',
    "on_modify": ffi.Function('int', [_library._zend_ini_entry ? ref.refType(_library._zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']),
    "orig_modifiable": 'int',
...
_library.zend_ini_parser_cb_t = ffi.Function('void', [_library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer', 'int', ref.refType('void')]);
...
_library.zend_register_ini_entries = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', 'int']];
...
_library.display_ini_entries = ['void', [_library.zend_module_entry ? ref.refType(_library.zend_module_entry) : 'pointer']];
...
_library.zend_ini_register_displayer = ['int', [ref.refType('char'), 'uint', ffi.Function('void', [_library._zend_ini_entry ? ref.refType(_library._zend_ini_entry) : 'pointer', 'int'])]];
_library._functions.push(_library.zend_ini_register_displayer);

_library.zend_ini_boolean_displayer_cb = ['void', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', 'int']];
_library._functions.push(_library.zend_ini_boolean_displayer_cb);

_library.zend_ini_color_displayer_cb = ['void', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', 'int']];
_library._functions.push(_library.zend_ini_color_displayer_cb);

_library.display_link_numbers = ['void', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', 'int']];
_library._functions.push(_library.display_link_numbers);

_library.OnUpdateBool = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateBool);

_library.OnUpdateLong = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateLong);

_library.OnUpdateLongGEZero = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateLongGEZero);

_library.OnUpdateReal = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateReal);

_library.OnUpdateString = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateString);

_library.OnUpdateStringUnempty = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
_library._functions.push(_library.OnUpdateStringUnempty);

_library.zend_parse_ini_file = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', 'uchar', 'int', _library.zend_ini_parser_cb_t, ref.refType('void')]];
