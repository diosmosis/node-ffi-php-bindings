...
_library._preload['zend_compiler_globals'] = [function () {
    _library.zend_compiler_globals = _library._zend_compiler_globals;
}];

_library._preload['zend_executor_globals'] = [function () {
    _library.zend_executor_globals = _library._zend_executor_globals;
}];

_library._preload['zend_php_scanner_globals'] = [function () {
    _library.zend_php_scanner_globals = _library._zend_php_scanner_globals;
}];

_library._preload['zend_ini_scanner_globals'] = [function () {
