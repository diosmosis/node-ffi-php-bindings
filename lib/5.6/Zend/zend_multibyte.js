...
_library.zend_multibyte_set_functions = ['int', [_library.zend_multibyte_functions ? ref.refType(_library.zend_multibyte_functions) : 'pointer']];
_library._functions.push(_library.zend_multibyte_set_functions);

_library.zend_multibyte_get_functions = [_library.zend_multibyte_functions ? ref.refType(_library.zend_multibyte_functions) : 'pointer', []];
_library._functions.push(_library.zend_multibyte_get_functions);

_library.zend_multibyte_fetch_encoding = [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', [ref.refType('char')]];
_library._functions.push(_library.zend_multibyte_fetch_encoding);

_library.zend_multibyte_get_encoding_name = [ref.refType('char'), [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
_library._functions.push(_library.zend_multibyte_get_encoding_name);

_library.zend_multibyte_check_lexer_compatibility = ['int', [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
_library._functions.push(_library.zend_multibyte_check_lexer_compatibility);

_library.zend_multibyte_encoding_detector = [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', [ref.refType('uchar'), 'ulong', _library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer' ? ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer') : 'pointer', 'ulong']];
_library._functions.push(_library.zend_multibyte_encoding_detector);

_library.zend_multibyte_encoding_converter = ['ulong', [ref.refType(ref.refType('uchar')), ref.refType('ulong'), ref.refType('uchar'), 'ulong', _library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', _library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
_library._functions.push(_library.zend_multibyte_encoding_converter);

_library.zend_multibyte_parse_encoding_list = ['int', [ref.refType('char'), 'ulong', _library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer' ? ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer') : 'pointer' ? ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer' ? ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer') : 'pointer') : 'pointer', ref.refType('ulong'), 'int']];
_library._functions.push(_library.zend_multibyte_parse_encoding_list);

_library.zend_multibyte_get_internal_encoding = [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', []];
_library._functions.push(_library.zend_multibyte_get_internal_encoding);

_library.zend_multibyte_get_script_encoding = [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', []];
_library._functions.push(_library.zend_multibyte_get_script_encoding);

_library.zend_multibyte_set_script_encoding = ['int', [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer' ? ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer') : 'pointer', 'ulong']];
_library._functions.push(_library.zend_multibyte_set_script_encoding);

_library.zend_multibyte_set_internal_encoding = ['int', [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
