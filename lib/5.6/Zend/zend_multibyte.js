...
_library.zend_multibyte_encoding_detector = [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer', [ref.refType('uchar'), 'ulong', ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer'), 'ulong']];
...
_library.zend_multibyte_parse_encoding_list = ['int', [ref.refType('char'), 'ulong', ref.refType(ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer')), ref.refType('ulong'), 'int']];
...
_library.zend_multibyte_set_script_encoding = ['int', [ref.refType(_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer'), 'ulong']];
