...
_library._zend_lex_state.size = 1;

_library._preload['_zend_lex_state'] = ['zend_stack', '_zend_stack', 'zend_ptr_stack', '_zend_ptr_stack', 'zend_file_handle', 'zend_encoding_filter', 'zend_encoding_filter', 'zend_encoding', function () {
    _library._zend_lex_state.size = 0;
...
_library._preload['zend_lex_state'] = [function () {
    _library.zend_lex_state = _library._zend_lex_state;
}];

_library._zend_heredoc_label = Struct({});
_library._zend_heredoc_label.size = 1;

_library._preload['_zend_heredoc_label'] = [function () {
    _library._zend_heredoc_label.size = 0;
    _library._zend_heredoc_label.defineProperty("label", ref.refType('char'));
    _library._zend_heredoc_label.defineProperty("length", 'int');
}];

_library._preload['zend_heredoc_label'] = [function () {
    _library.zend_heredoc_label = _library._zend_heredoc_label;
}];

_library._preload['zend_save_lexical_state'] = ['zend_lex_state', function () {
...
_library._preload['zend_restore_lexical_state'] = ['zend_lex_state', function () {
...
_library._preload['zend_prepare_string_for_scanning'] = ['zval', function () {
...
_library._preload['zend_multibyte_yyinput_again'] = ['zend_encoding_filter', 'zend_encoding', function () {
...
_library._preload['zend_multibyte_set_filter'] = ['zend_encoding', function () {
