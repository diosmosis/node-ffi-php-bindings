...
_library._zend_lex_state = Struct({
    ...
    "in": _library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer',
...
_library.zend_save_lexical_state = ['void', [_library.zend_lex_state ? ref.refType(_library.zend_lex_state) : 'pointer']];
_library._functions.push(_library.zend_save_lexical_state);

_library.zend_restore_lexical_state = ['void', [_library.zend_lex_state ? ref.refType(_library.zend_lex_state) : 'pointer']];
_library._functions.push(_library.zend_restore_lexical_state);

_library.zend_prepare_string_for_scanning = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer', ref.refType('char')]];
_library._functions.push(_library.zend_prepare_string_for_scanning);

_library.zend_multibyte_yyinput_again = ['void', [_library.zend_encoding_filter, _library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
_library._functions.push(_library.zend_multibyte_yyinput_again);

_library.zend_multibyte_set_filter = ['int', [_library.zend_encoding ? ref.refType(_library.zend_encoding) : 'pointer']];
