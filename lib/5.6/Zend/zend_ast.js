...
_library.zend_ast_dynamic_add = ['void', [_library.zend_ast ? ref.refType(_library.zend_ast) : 'pointer' ? ref.refType(_library.zend_ast ? ref.refType(_library.zend_ast) : 'pointer') : 'pointer', _library.zend_ast ? ref.refType(_library.zend_ast) : 'pointer']];
_library._functions.push(_library.zend_ast_dynamic_add);

_library.zend_ast_dynamic_shrink = ['void', [_library.zend_ast ? ref.refType(_library.zend_ast) : 'pointer' ? ref.refType(_library.zend_ast ? ref.refType(_library.zend_ast) : 'pointer') : 'pointer']];
