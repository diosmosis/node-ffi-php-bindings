...
_library.zend_ast_dynamic_add = ['void', [ref.refType(_library.zend_ast) ? ref.refType(ref.refType(_library.zend_ast)) : 'pointer', ref.refType(_library.zend_ast)]];
_library._functions.push(_library.zend_ast_dynamic_add);

_library.zend_ast_dynamic_shrink = ['void', [ref.refType(_library.zend_ast) ? ref.refType(ref.refType(_library.zend_ast)) : 'pointer']];
