...
_library.zend_get_constant = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', ref.refType(_library.zval)]];
_library._functions.push(_library.zend_get_constant);

_library.zend_get_constant_ex = ['int', ['char' ? ref.refType('char') : 'pointer', 'uint', ref.refType(_library.zval), ref.refType(_library.zend_class_entry), 'ulong']];
_library._functions.push(_library.zend_get_constant_ex);

_library.zend_register_bool_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'uchar', 'int', 'int']];
_library._functions.push(_library.zend_register_bool_constant);

_library.zend_register_null_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'int', 'int']];
_library._functions.push(_library.zend_register_null_constant);

_library.zend_register_long_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'long', 'int', 'int']];
_library._functions.push(_library.zend_register_long_constant);

_library.zend_register_double_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'double', 'int', 'int']];
_library._functions.push(_library.zend_register_double_constant);

_library.zend_register_string_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'int', 'int']];
_library._functions.push(_library.zend_register_string_constant);

_library.zend_register_stringl_constant = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint', 'int', 'int']];
