...
_library.llist_dtor_func_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer']);

_library.llist_compare_func_t = ffi.Function('int', [ref.refType(_library._zend_llist_element) ? ref.refType(ref.refType(_library._zend_llist_element)) : 'pointer', ref.refType(_library._zend_llist_element) ? ref.refType(ref.refType(_library._zend_llist_element)) : 'pointer']);

_library.llist_apply_with_args_func_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer', 'int', 'void' ? ref.refType('void') : 'pointer']);

_library.llist_apply_with_arg_func_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer', 'void' ? ref.refType('void') : 'pointer']);

_library.llist_apply_func_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer']);
...
_library.zend_llist_add_element = ['void', [ref.refType(_library.zend_llist), 'void' ? ref.refType('void') : 'pointer']];
_library._functions.push(_library.zend_llist_add_element);

_library.zend_llist_prepend_element = ['void', [ref.refType(_library.zend_llist), 'void' ? ref.refType('void') : 'pointer']];
_library._functions.push(_library.zend_llist_prepend_element);

_library.zend_llist_del_element = ['void', [ref.refType(_library.zend_llist), 'void' ? ref.refType('void') : 'pointer', ffi.Function('int', ['void' ? ref.refType('void') : 'pointer', 'void' ? ref.refType('void') : 'pointer'])]];
...
_library.zend_llist_remove_tail = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zend_llist)]];
...
_library.zend_llist_apply_with_del = ['void', [ref.refType(_library.zend_llist), ffi.Function('int', ['void' ? ref.refType('void') : 'pointer'])]];
_library._functions.push(_library.zend_llist_apply_with_del);

_library.zend_llist_apply_with_argument = ['void', [ref.refType(_library.zend_llist), _library.llist_apply_with_arg_func_t, 'void' ? ref.refType('void') : 'pointer']];
...
_library.zend_llist_get_first_ex = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zend_llist), ref.refType(_library.zend_llist_position)]];
_library._functions.push(_library.zend_llist_get_first_ex);

_library.zend_llist_get_last_ex = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zend_llist), ref.refType(_library.zend_llist_position)]];
_library._functions.push(_library.zend_llist_get_last_ex);

_library.zend_llist_get_next_ex = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zend_llist), ref.refType(_library.zend_llist_position)]];
_library._functions.push(_library.zend_llist_get_next_ex);

_library.zend_llist_get_prev_ex = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zend_llist), ref.refType(_library.zend_llist_position)]];
