...
_library.llist_compare_func_t = ffi.Function('int', [_library._zend_llist_element ? ref.refType(_library._zend_llist_element) : 'pointer' ? ref.refType(_library._zend_llist_element ? ref.refType(_library._zend_llist_element) : 'pointer') : 'pointer', _library._zend_llist_element ? ref.refType(_library._zend_llist_element) : 'pointer' ? ref.refType(_library._zend_llist_element ? ref.refType(_library._zend_llist_element) : 'pointer') : 'pointer']);
