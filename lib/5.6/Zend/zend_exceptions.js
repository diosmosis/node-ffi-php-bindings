...
_library.zend_throw_exception = [ref.refType(_library.zval), [ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'long']];
...
_library.zend_throw_error_exception = [ref.refType(_library.zval), [ref.refType(_library.zend_class_entry), 'char' ? ref.refType('char') : 'pointer', 'long', 'int']];
