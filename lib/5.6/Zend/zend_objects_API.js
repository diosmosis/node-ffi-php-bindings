...
_library.zend_objects_store_dtor_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer', 'uint']);

_library.zend_objects_free_object_storage_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer']);

_library.zend_objects_store_clone_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer', 'void' ? ref.refType('void') : 'pointer' ? ref.refType('void' ? ref.refType('void') : 'pointer') : 'pointer']);
...
_library._store_object = Struct({
    ...
    "object": 'void' ? ref.refType('void') : 'pointer',
    "refcount": 'uint'
});
...
_library.zend_objects_store_put = ['uint', ['void' ? ref.refType('void') : 'pointer', _library.zend_objects_store_dtor_t, _library.zend_objects_free_object_storage_t, _library.zend_objects_store_clone_t]];
...
_library.zend_object_store_get_object = ['void' ? ref.refType('void') : 'pointer', [ref.refType(_library.zval)]];
_library._functions.push(_library.zend_object_store_get_object);

_library.zend_object_store_get_object_by_handle = ['void' ? ref.refType('void') : 'pointer', ['uint']];
_library._functions.push(_library.zend_object_store_get_object_by_handle);

_library.zend_object_store_set_object = ['void', [ref.refType(_library.zval), 'void' ? ref.refType('void') : 'pointer']];
