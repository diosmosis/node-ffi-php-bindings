...
_library._preload['_zend_extension'] = ['activate_func_t', 'int (int)', 'int (const char *)', 'deactivate_func_t', 'fcall_begin_handler_func_t', 'fcall_end_handler_func_t', 'message_handler_func_t', 'op_array_ctor_func_t', 'op_array_dtor_func_t', 'op_array_handler_func_t', 'shutdown_func_t', 'startup_func_t', 'statement_handler_func_t', function () {
