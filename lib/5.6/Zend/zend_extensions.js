...
_library.fcall_begin_handler_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);

_library.fcall_end_handler_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);

_library.message_handler_func_t = ffi.Function('void', ['int', ref.refType('void')]);

_library.op_array_ctor_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);

_library.op_array_dtor_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);

_library.op_array_handler_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);

_library.shutdown_func_t = ffi.Function('void', [_library._zend_extension ? ref.refType(_library._zend_extension) : 'pointer']);

_library.startup_func_t = ffi.Function('int', [_library._zend_extension ? ref.refType(_library._zend_extension) : 'pointer']);

_library.statement_handler_func_t = ffi.Function('void', [_library._zend_op_array ? ref.refType(_library._zend_op_array) : 'pointer']);
...
_library.zend_get_resource_handle = ['int', [_library.zend_extension ? ref.refType(_library.zend_extension) : 'pointer']];
...
_library.zend_extension_dtor = ['void', [_library.zend_extension ? ref.refType(_library.zend_extension) : 'pointer']];
_library._functions.push(_library.zend_extension_dtor);

_library.zend_append_version_info = ['void', [_library.zend_extension ? ref.refType(_library.zend_extension) : 'pointer']];
...
_library.zend_register_extension = ['int', [_library.zend_extension ? ref.refType(_library.zend_extension) : 'pointer', ref.refType('void')]];
_library._functions.push(_library.zend_register_extension);

_library.zend_get_extension = [_library.zend_extension ? ref.refType(_library.zend_extension) : 'pointer', [ref.refType('char')]];
