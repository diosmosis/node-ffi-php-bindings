...
_library._zend_file_handle = Struct({
    ...
    "handle": Union({
        "fd": 'int',
        "fp": _library.FILE ? ref.refType(_library.FILE) : 'pointer',
...
_library.zend_stream_open = ['int', [ref.refType('char'), _library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
_library._functions.push(_library.zend_stream_open);

_library.zend_stream_fixup = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', ref.refType(ref.refType('char')), ref.refType('ulong')]];
_library._functions.push(_library.zend_stream_fixup);

_library.zend_file_handle_dtor = ['void', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
_library._functions.push(_library.zend_file_handle_dtor);

_library.zend_compare_file_handles = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', _library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
