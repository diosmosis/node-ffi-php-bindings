...
_library._preload.push(function () {
    ...
    _library._php_output_handler.defineProperty("func", Union({}));
    _library._php_output_handler.fields.func.type.defineProperty("internal", _library.php_output_handler_context_func_t);
    _library._php_output_handler.fields.func.type.defineProperty("user", ref.refType(_library.php_output_handler_user_func_t));
...
_library._functions['zif_ob_start'] = _library.zif_ob_start;
...
_library._functions['zif_ob_flush'] = _library.zif_ob_flush;
...
_library._functions['zif_ob_clean'] = _library.zif_ob_clean;
...
_library._functions['zif_ob_end_flush'] = _library.zif_ob_end_flush;
...
_library._functions['zif_ob_end_clean'] = _library.zif_ob_end_clean;
...
_library._functions['zif_ob_get_flush'] = _library.zif_ob_get_flush;
...
_library._functions['zif_ob_get_clean'] = _library.zif_ob_get_clean;
...
_library._functions['zif_ob_get_contents'] = _library.zif_ob_get_contents;
...
_library._functions['zif_ob_get_length'] = _library.zif_ob_get_length;
...
_library._functions['zif_ob_get_level'] = _library.zif_ob_get_level;
...
_library._functions['zif_ob_get_status'] = _library.zif_ob_get_status;
...
_library._functions['zif_ob_implicit_flush'] = _library.zif_ob_implicit_flush;
...
_library._functions['zif_ob_list_handlers'] = _library.zif_ob_list_handlers;
...
_library._functions['zif_output_add_rewrite_var'] = _library.zif_output_add_rewrite_var;
...
_library._functions['zif_output_reset_rewrite_vars'] = _library.zif_output_reset_rewrite_vars;
