...
_library.php_output_handler_func_t = ffi.Function('void', ['char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'uint' ? ref.refType('uint') : 'pointer', 'int']);

_library.php_output_handler_context_func_t = ffi.Function('int', ['void' ? ref.refType('void') : 'pointer' ? ref.refType('void' ? ref.refType('void') : 'pointer') : 'pointer', ref.refType(_library._php_output_context)]);

_library.php_output_handler_context_dtor_t = ffi.Function('void', ['void' ? ref.refType('void') : 'pointer']);

_library.php_output_handler_conflict_check_t = ffi.Function('int', ['char' ? ref.refType('char') : 'pointer', 'ulong']);
...
_library._php_output_handler = Struct({
    ...
    "dtor": ffi.Function('void', ['void' ? ref.refType('void') : 'pointer']),
    "flags": 'int',
    "func": Union({
    ...
    "name_len": 'ulong',
    "opaq": 'void' ? ref.refType('void') : 'pointer',
    "size": 'ulong'
});

_library.php_output_handler_alias_ctor_t = ffi.Function(ref.refType(_library._php_output_handler), ['char' ? ref.refType('char') : 'pointer', 'ulong', 'ulong', 'int']);
...
_library._zend_output_globals = Struct({
    ...
    "output_start_filename": 'char' ? ref.refType('char') : 'pointer',
...
_library.php_output_get_start_filename = ['char' ? ref.refType('char') : 'pointer', []];
...
_library.php_output_write_unbuffered = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong']];
_library._functions.push(_library.php_output_write_unbuffered);

_library.php_output_write = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong']];
...
_library.php_output_start_internal = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong', _library.php_output_handler_func_t, 'ulong', 'int']];
...
_library.php_output_handler_create_internal = [ref.refType(_library.php_output_handler), ['char' ? ref.refType('char') : 'pointer', 'ulong', _library.php_output_handler_context_func_t, 'ulong', 'int']];
_library._functions.push(_library.php_output_handler_create_internal);

_library.php_output_handler_set_context = ['void', [ref.refType(_library.php_output_handler), 'void' ? ref.refType('void') : 'pointer', ffi.Function('void', ['void' ? ref.refType('void') : 'pointer'])]];
...
_library.php_output_handler_started = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong']];
_library._functions.push(_library.php_output_handler_started);

_library.php_output_handler_hook = ['int', [_library.php_output_handler_hook_t, 'void' ? ref.refType('void') : 'pointer']];
...
_library.php_output_handler_free = ['void', [ref.refType(_library.php_output_handler) ? ref.refType(ref.refType(_library.php_output_handler)) : 'pointer']];
_library._functions.push(_library.php_output_handler_free);

_library.php_output_handler_conflict = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong', 'char' ? ref.refType('char') : 'pointer', 'ulong']];
_library._functions.push(_library.php_output_handler_conflict);

_library.php_output_handler_conflict_register = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong', _library.php_output_handler_conflict_check_t]];
_library._functions.push(_library.php_output_handler_conflict_register);

_library.php_output_handler_reverse_conflict_register = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong', _library.php_output_handler_conflict_check_t]];
_library._functions.push(_library.php_output_handler_reverse_conflict_register);

_library.php_output_handler_alias = [ref.refType(_library.php_output_handler_alias_ctor_t), ['char' ? ref.refType('char') : 'pointer', 'ulong']];
_library._functions.push(_library.php_output_handler_alias);

_library.php_output_handler_alias_register = ['int', ['char' ? ref.refType('char') : 'pointer', 'ulong', _library.php_output_handler_alias_ctor_t]];
_library._functions.push(_library.php_output_handler_alias_register);

_library.zif_ob_start = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_start);

_library.zif_ob_flush = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_flush);

_library.zif_ob_clean = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_clean);

_library.zif_ob_end_flush = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_end_flush);

_library.zif_ob_end_clean = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_end_clean);

_library.zif_ob_get_flush = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_flush);

_library.zif_ob_get_clean = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_clean);

_library.zif_ob_get_contents = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_contents);

_library.zif_ob_get_length = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_length);

_library.zif_ob_get_level = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_level);

_library.zif_ob_get_status = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_get_status);

_library.zif_ob_implicit_flush = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_implicit_flush);

_library.zif_ob_list_handlers = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_ob_list_handlers);

_library.zif_output_add_rewrite_var = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_output_add_rewrite_var);

_library.zif_output_reset_rewrite_vars = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
