...
_library.php_output_handler_context_func_t = ffi.Function('int', [ref.refType(ref.refType('void')), _library._php_output_context ? ref.refType(_library._php_output_context) : 'pointer']);
...
_library._php_output_handler_user_func_t = Struct({
    ...
    "zoh": _library.zval ? ref.refType(_library.zval) : 'pointer'
});
...
_library._php_output_handler = Struct({
    ...
    "func": Union({
        ...
        "user": _library.php_output_handler_user_func_t ? ref.refType(_library.php_output_handler_user_func_t) : 'pointer'
    }),
    "level": 'int',
...
_library.php_output_handler_alias_ctor_t = ffi.Function(_library._php_output_handler ? ref.refType(_library._php_output_handler) : 'pointer', [ref.refType('char'), 'ulong', 'ulong', 'int']);

_library.php_output_handler = _library._php_output_handler;

_library._zend_output_globals = Struct({
    "active": _library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer',
    "flags": 'int',
    "handlers": _library.zend_stack,
    "output_start_filename": ref.refType('char'),
    "output_start_lineno": 'int',
    "running": _library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer'
});
...
_library.php_output_get_contents = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer']];
_library._functions.push(_library.php_output_get_contents);

_library.php_output_get_length = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer']];
...
_library.php_output_get_active_handler = [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer', []];
...
_library.php_output_start_user = ['int', [_library.zval ? ref.refType(_library.zval) : 'pointer', 'ulong', 'int']];
...
_library.php_output_handler_create_user = [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer', [_library.zval ? ref.refType(_library.zval) : 'pointer', 'ulong', 'int']];
_library._functions.push(_library.php_output_handler_create_user);

_library.php_output_handler_create_internal = [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer', [ref.refType('char'), 'ulong', _library.php_output_handler_context_func_t, 'ulong', 'int']];
_library._functions.push(_library.php_output_handler_create_internal);

_library.php_output_handler_set_context = ['void', [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer', ref.refType('void'), ffi.Function('void', [ref.refType('void')])]];
_library._functions.push(_library.php_output_handler_set_context);

_library.php_output_handler_start = ['int', [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer']];
...
_library.php_output_handler_dtor = ['void', [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer']];
_library._functions.push(_library.php_output_handler_dtor);

_library.php_output_handler_free = ['void', [_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer' ? ref.refType(_library.php_output_handler ? ref.refType(_library.php_output_handler) : 'pointer') : 'pointer']];
...
_library.php_output_handler_alias = [_library.php_output_handler_alias_ctor_t ? ref.refType(_library.php_output_handler_alias_ctor_t) : 'pointer', [ref.refType('char'), 'ulong']];
...
_library.zif_ob_start = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_start);

_library.zif_ob_flush = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_flush);

_library.zif_ob_clean = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_clean);

_library.zif_ob_end_flush = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_end_flush);

_library.zif_ob_end_clean = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_end_clean);

_library.zif_ob_get_flush = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_flush);

_library.zif_ob_get_clean = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_clean);

_library.zif_ob_get_contents = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_contents);

_library.zif_ob_get_length = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_length);

_library.zif_ob_get_level = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_level);

_library.zif_ob_get_status = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_get_status);

_library.zif_ob_implicit_flush = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_implicit_flush);

_library.zif_ob_list_handlers = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_ob_list_handlers);

_library.zif_output_add_rewrite_var = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
_library._functions.push(_library.zif_output_add_rewrite_var);

_library.zif_output_reset_rewrite_vars = ['void', ['int', _library.zval ? ref.refType(_library.zval) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer', 'int']];
