...
_library.php_module_startup = ['int', [_library.sapi_module_struct ? ref.refType(_library.sapi_module_struct) : 'pointer', _library.zend_module_entry ? ref.refType(_library.zend_module_entry) : 'pointer', 'uint']];
...
_library.php_module_shutdown_wrapper = ['int', [_library.sapi_module_struct ? ref.refType(_library.sapi_module_struct) : 'pointer']];
...
_library.php_register_extensions = ['int', [_library.zend_module_entry ? ref.refType(_library.zend_module_entry) : 'pointer' ? ref.refType(_library.zend_module_entry ? ref.refType(_library.zend_module_entry) : 'pointer') : 'pointer', 'int']];
_library._functions.push(_library.php_register_extensions);

_library.php_execute_script = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
_library._functions.push(_library.php_execute_script);

_library.php_execute_simple_script = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', _library.zval ? ref.refType(_library.zval) : 'pointer' ? ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer') : 'pointer']];
...
_library.php_lint_script = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
...
_library.php_stream_open_for_zend_ex = ['int', [ref.refType('char'), _library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', 'int']];
