...
_library.php_register_extensions = ['int', [ref.refType(_library.zend_module_entry ? ref.refType(_library.zend_module_entry) : 'pointer'), 'int']];
...
_library.php_execute_simple_script = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer', ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer')]];
