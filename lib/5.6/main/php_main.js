...
_library.php_request_shutdown = ['void', ['void' ? ref.refType('void') : 'pointer']];
_library._functions.push(_library.php_request_shutdown);

_library.php_request_shutdown_for_exec = ['void', ['void' ? ref.refType('void') : 'pointer']];
...
_library.php_request_shutdown_for_hook = ['void', ['void' ? ref.refType('void') : 'pointer']];
_library._functions.push(_library.php_request_shutdown_for_hook);

_library.php_register_extensions = ['int', [ref.refType(_library.zend_module_entry) ? ref.refType(ref.refType(_library.zend_module_entry)) : 'pointer', 'int']];
...
_library.php_execute_simple_script = ['int', [ref.refType(_library.zend_file_handle), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer']];
...
_library.php_handle_auth_data = ['int', ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.php_handle_auth_data);

_library.php_html_puts = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.php_html_puts);

_library.php_stream_open_for_zend_ex = ['int', ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.zend_file_handle), 'int']];
