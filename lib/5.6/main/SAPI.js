...
_library._sapi_module_struct = Struct({
    ...
    "additional_functions": _library.zend_function_entry ? ref.refType(_library.zend_function_entry) : 'pointer',
    ...
    "get_stat": ffi.Function(_library.stat ? ref.refType(_library.stat) : 'pointer', []),
    ...
    "header_handler": ffi.Function('int', [_library.sapi_header_struct ? ref.refType(_library.sapi_header_struct) : 'pointer', _library.sapi_header_op_enum, _library.sapi_headers_struct ? ref.refType(_library.sapi_headers_struct) : 'pointer']),
    "ini_defaults": ffi.Function('void', [_library._hashtable ? ref.refType(_library._hashtable) : 'pointer']),
    ...
    "register_server_variables": ffi.Function('void', [_library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer']),
    "sapi_error": ffi.Function('void', ['int', ref.refType('char')]),
    "send_header": ffi.Function('void', [_library.sapi_header_struct ? ref.refType(_library.sapi_header_struct) : 'pointer', ref.refType('void')]),
    "send_headers": ffi.Function('int', [_library.sapi_headers_struct ? ref.refType(_library.sapi_headers_struct) : 'pointer']),
    "shutdown": ffi.Function('int', [_library._sapi_module_struct ? ref.refType(_library._sapi_module_struct) : 'pointer']),
    "startup": ffi.Function('int', [_library._sapi_module_struct ? ref.refType(_library._sapi_module_struct) : 'pointer']),
    "terminate_process": ffi.Function('void', []),
    "treat_data": ffi.Function('void', ['int', ref.refType('char'), _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer']),
...
_library.sapi_request_info = Struct({
    ...
    "post_entry": _library.sapi_post_entry ? ref.refType(_library.sapi_post_entry) : 'pointer',
    "proto_num": 'int',
    "query_string": ref.refType('char'),
    "request_body": _library._php_stream ? ref.refType(_library._php_stream) : 'pointer',
    "request_method": ref.refType('char'),
    "request_uri": ref.refType('char')
})

_library._sapi_globals_struct = Struct({
    "callback_func": _library.zval ? ref.refType(_library.zval) : 'pointer',
    "callback_run": 'uchar',
    ...
    "rfc1867_uploaded_files": _library.HashTable ? ref.refType(_library.HashTable) : 'pointer',
...
_library.sapi_startup = ['void', [_library.sapi_module_struct ? ref.refType(_library.sapi_module_struct) : 'pointer']];
...
_library.sapi_free_header = ['void', [_library.sapi_header_struct ? ref.refType(_library.sapi_header_struct) : 'pointer']];
...
_library.sapi_register_post_entries = ['int', [_library.sapi_post_entry ? ref.refType(_library.sapi_post_entry) : 'pointer']];
_library._functions.push(_library.sapi_register_post_entries);

_library.sapi_register_post_entry = ['int', [_library.sapi_post_entry ? ref.refType(_library.sapi_post_entry) : 'pointer']];
_library._functions.push(_library.sapi_register_post_entry);

_library.sapi_unregister_post_entry = ['void', [_library.sapi_post_entry ? ref.refType(_library.sapi_post_entry) : 'pointer']];
...
_library.sapi_register_treat_data = ['int', [ffi.Function('void', ['int', ref.refType('char'), _library._zval_struct ? ref.refType(_library._zval_struct) : 'pointer'])]];
...
_library.sapi_get_stat = [_library.stat ? ref.refType(_library.stat) : 'pointer', []];
...
_library.sapi_get_default_content_type_header = ['void', [_library.sapi_header_struct ? ref.refType(_library.sapi_header_struct) : 'pointer']];
...
_library.sapi_get_target_uid = ['int', [_library.uid_t ? ref.refType(_library.uid_t) : 'pointer']];
_library._functions.push(_library.sapi_get_target_uid);

_library.sapi_get_target_gid = ['int', [_library.gid_t ? ref.refType(_library.gid_t) : 'pointer']];
...
_library.php_default_treat_data = ['void', ['int', ref.refType('char'), _library.zval ? ref.refType(_library.zval) : 'pointer']];
