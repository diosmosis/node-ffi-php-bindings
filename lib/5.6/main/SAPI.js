...
_library._preload['_sapi_post_entry'] = ['void (char *, void *)', 'void (void)', function () {
...
_library._preload['_sapi_module_struct'] = ['int (void)', 'zend_function_entry', 'void (void)', 'int (void)', 'void (void)', 'void (void *)', 'int (void)', 'int (int *)', 'double (void)', 'stat *(void)', 'int (gid_t *)', 'int (uid_t *)', 'char *(char *, size_t)', 'int (sapi_header_struct *, sapi_header_op_enum, sapi_headers_struct *)', 'void (HashTable *)', 'unsigned int (int, char *, char **, unsigned int, unsigned int *)', 'unsigned int (void)', 'void (char *)', 'char *(void)', 'int (char *, uint)', 'void (zval *)', 'void (int, const char *, ...)', 'void (sapi_header_struct *, void *)', 'int (sapi_headers_struct *)', 'int (struct _sapi_module_struct *)', 'int (struct _sapi_module_struct *)', 'void (void)', 'void (int, char *, zval *)', 'int (const char *, unsigned int)', 'void (void)', function () {
...
_library._preload['sapi_request_info'] = ['pointer', 'sapi_post_entry', '_php_stream', function () {
...
_library._preload['_sapi_globals_struct'] = ['zval', 'zend_fcall_info_cache', '_zend_fcall_info_cache', 'stat', 'stat', 'HashTable', '_hashtable', 'sapi_request_info', 'sapi_request_info', 'HashTable', 'sapi_headers_struct', 'sapi_headers_struct', function () {
