...
_library.config_zval_dtor = ['void', [_library.zval ? ref.refType(_library.zval) : 'pointer']];
...
_library.cfg_get_entry = [_library.zval ? ref.refType(_library.zval) : 'pointer', [ref.refType('char'), 'uint']];
...
_library.php_parse_user_ini_file = ['int', [ref.refType('char'), ref.refType('char'), _library.HashTable ? ref.refType(_library.HashTable) : 'pointer']];
_library._functions.push(_library.php_parse_user_ini_file);

_library.php_ini_activate_config = ['void', [_library.HashTable ? ref.refType(_library.HashTable) : 'pointer', 'int', 'int']];
...
_library.php_ini_get_configuration_hash = [_library.HashTable ? ref.refType(_library.HashTable) : 'pointer', []];
