...
_library.cfg_get_entry = [ref.refType(_library.zval), ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.cfg_get_entry);

_library.cfg_get_long = ['int', ['char' ? ref.refType('char') : 'pointer', 'long' ? ref.refType('long') : 'pointer']];
_library._functions.push(_library.cfg_get_long);

_library.cfg_get_double = ['int', ['char' ? ref.refType('char') : 'pointer', 'double' ? ref.refType('double') : 'pointer']];
_library._functions.push(_library.cfg_get_double);

_library.cfg_get_string = ['int', ['char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer']];
_library._functions.push(_library.cfg_get_string);

_library.php_parse_user_ini_file = ['int', ['char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer', ref.refType(_library.HashTable)]];
...
_library.php_ini_activate_per_dir_config = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library.php_ini_activate_per_dir_config);

_library.php_ini_activate_per_host_config = ['void', ['char' ? ref.refType('char') : 'pointer', 'uint']];
