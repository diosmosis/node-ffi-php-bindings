...
_library._functions['php_init_config'] = _library.php_init_config;

_library.php_shutdown_config = ['int', []];
_library._functions['php_shutdown_config'] = _library.php_shutdown_config;

_library.php_ini_register_extensions = ['void', []];
_library._functions['php_ini_register_extensions'] = _library.php_ini_register_extensions;
