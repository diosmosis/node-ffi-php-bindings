...
_library.php_stream_from_persistent_id = ['int', [ref.refType('char'), ref.refType(_library.php_stream ? ref.refType(_library.php_stream) : 'pointer')]];
...
_library._php_stream_make_seekable = ['int', [_library.php_stream ? ref.refType(_library.php_stream) : 'pointer', ref.refType(_library.php_stream ? ref.refType(_library.php_stream) : 'pointer'), 'int', 'int', ref.refType('char'), 'uint', ref.refType('char'), 'uint']];
