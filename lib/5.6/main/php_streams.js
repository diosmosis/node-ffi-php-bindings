...
_library._preload['_php_stream_ops'] = ['int (php_stream *, int, void **)', 'int (php_stream *, int)', 'int (php_stream *)', 'size_t (php_stream *, char *, size_t)', 'int (php_stream *, off_t, int, off_t *)', 'int (php_stream *, int, int, void *)', 'int (php_stream *, php_stream_statbuf *)', 'size_t (php_stream *, const char *, size_t)', function () {
...
_library._preload['_php_stream'] = ['php_stream_context', '_php_stream', 'php_stream_ops', 'off_t', 'php_stream_filter_chain', '_php_stream_filter_chain', 'off_t', 'FILE', 'php_stream_wrapper', 'zval', 'php_stream_filter_chain', '_php_stream_filter_chain', 'off_t', function () {
