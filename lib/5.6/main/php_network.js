...
_library.php_network_getaddresses = ['int', [ref.refType('char'), 'int', ref.refType(ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer')), ref.refType(ref.refType('char'))]];
_library._functions.push(_library.php_network_getaddresses);

_library.php_network_freeaddresses = ['void', [ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer')]];
...
_library.php_network_accept_incoming = ['int', ['int', ref.refType(ref.refType('char')), ref.refType('long'), ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer'), _library.socklen_t ? ref.refType(_library.socklen_t) : 'pointer', _library.timeval ? ref.refType(_library.timeval) : 'pointer', ref.refType(ref.refType('char')), ref.refType('int')]];
_library._functions.push(_library.php_network_accept_incoming);

_library.php_network_get_sock_name = ['int', ['int', ref.refType(ref.refType('char')), ref.refType('long'), ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer'), _library.socklen_t ? ref.refType(_library.socklen_t) : 'pointer']];
_library._functions.push(_library.php_network_get_sock_name);

_library.php_network_get_peer_name = ['int', ['int', ref.refType(ref.refType('char')), ref.refType('long'), ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer'), _library.socklen_t ? ref.refType(_library.socklen_t) : 'pointer']];
...
_library.php_network_populate_name_from_sockaddr = ['void', [_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer', _library.socklen_t, ref.refType(ref.refType('char')), ref.refType('long'), ref.refType(_library.sockaddr ? ref.refType(_library.sockaddr) : 'pointer'), _library.socklen_t ? ref.refType(_library.socklen_t) : 'pointer']];
