...
_library.php_fopen_primary_script = ['int', [_library.zend_file_handle ? ref.refType(_library.zend_file_handle) : 'pointer']];
...
_library.php_fopen_with_path = [_library.FILE ? ref.refType(_library.FILE) : 'pointer', [ref.refType('char'), ref.refType('char'), ref.refType('char'), ref.refType(ref.refType('char'))]];
...
_library.OnUpdateBaseDir = ['int', [_library.zend_ini_entry ? ref.refType(_library.zend_ini_entry) : 'pointer', ref.refType('char'), 'uint', ref.refType('void'), ref.refType('void'), ref.refType('void'), 'int']];
