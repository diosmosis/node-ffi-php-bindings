...
_library._preload['_php_stream_memory_create'] = ['php_stream', function () {
    _library._php_stream_memory_create = [ref.refType(_library.php_stream), ['int', 'int', ref.refType('char'), 'uint', ref.refType('char'), 'uint']];
    _library._functions['_php_stream_memory_create'] = _library._php_stream_memory_create;
}];

_library._preload['_php_stream_memory_open'] = ['php_stream', function () {
    ...
    _library._functions['_php_stream_memory_open'] = _library._php_stream_memory_open;
}];

_library._preload['_php_stream_memory_get_buffer'] = ['php_stream', function () {
    ...
    _library._functions['_php_stream_memory_get_buffer'] = _library._php_stream_memory_get_buffer;
}];

_library._preload['_php_stream_temp_create'] = ['php_stream', function () {
    ...
    _library._functions['_php_stream_temp_create'] = _library._php_stream_temp_create;
}];

_library._preload['_php_stream_temp_create_ex'] = ['php_stream', function () {
    ...
    _library._functions['_php_stream_temp_create_ex'] = _library._php_stream_temp_create_ex;
}];

_library._preload['_php_stream_temp_open'] = ['php_stream', function () {
    ...
    _library._functions['_php_stream_temp_open'] = _library._php_stream_temp_open;
}];
