...
_library._preload['_php_glob_stream_get_path'] = ['php_stream', function () {
    ...
    _library._functions['_php_glob_stream_get_path'] = _library._php_glob_stream_get_path;
}];

_library._preload['_php_glob_stream_get_pattern'] = ['php_stream', function () {
    ...
    _library._functions['_php_glob_stream_get_pattern'] = _library._php_glob_stream_get_pattern;
}];

_library._preload['_php_glob_stream_get_count'] = ['php_stream', function () {
    ...
    _library._functions['_php_glob_stream_get_count'] = _library._php_glob_stream_get_count;
}];
