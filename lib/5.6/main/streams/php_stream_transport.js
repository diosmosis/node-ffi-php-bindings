...
_library.php_stream_xport_accept = ['int', [_library.php_stream ? ref.refType(_library.php_stream) : 'pointer', _library.php_stream ? ref.refType(_library.php_stream) : 'pointer' ? ref.refType(_library.php_stream ? ref.refType(_library.php_stream) : 'pointer') : 'pointer', ref.refType(ref.refType('char')), ref.refType('int'), ref.refType(ref.refType('void')), _library.socklen_t ? ref.refType(_library.socklen_t) : 'pointer', _library.timeval ? ref.refType(_library.timeval) : 'pointer', ref.refType(ref.refType('char'))]];
