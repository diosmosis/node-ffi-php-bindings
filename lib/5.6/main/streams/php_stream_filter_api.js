...
_library._php_stream_filter_ops = Struct({
    ...
    "filter": ffi.Function(_library.php_stream_filter_status_t, [ref.refType(_library._php_stream), ref.refType(_library._php_stream_filter), ref.refType(_library._php_stream_bucket_brigade), ref.refType(_library._php_stream_bucket_brigade), 'ulong' ? ref.refType('ulong') : 'pointer', 'int']),
...
_library.php_stream_bucket_new = [ref.refType(_library.php_stream_bucket), [ref.refType(_library.php_stream), 'char' ? ref.refType('char') : 'pointer', 'ulong', 'int', 'int']];
_library._functions.push(_library.php_stream_bucket_new);

_library.php_stream_bucket_split = ['int', [ref.refType(_library.php_stream_bucket), ref.refType(_library.php_stream_bucket) ? ref.refType(ref.refType(_library.php_stream_bucket)) : 'pointer', ref.refType(_library.php_stream_bucket) ? ref.refType(ref.refType(_library.php_stream_bucket)) : 'pointer', 'ulong']];
...
_library._php_stream_filter_alloc = [ref.refType(_library.php_stream_filter), [ref.refType(_library.php_stream_filter_ops), 'void' ? ref.refType('void') : 'pointer', 'int', 'int', 'char' ? ref.refType('char') : 'pointer', 'uint', 'char' ? ref.refType('char') : 'pointer', 'uint']];
_library._functions.push(_library._php_stream_filter_alloc);

_library._php_stream_filter_factory = Struct({
    "create_filter": ffi.Function(ref.refType(_library._php_stream_filter), ['char' ? ref.refType('char') : 'pointer', ref.refType(_library._zval_struct), 'int'])
});

_library.php_stream_filter_factory = _library._php_stream_filter_factory;

_library.php_stream_filter_register_factory = ['int', ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.php_stream_filter_factory)]];
_library._functions.push(_library.php_stream_filter_register_factory);

_library.php_stream_filter_unregister_factory = ['int', ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.php_stream_filter_unregister_factory);

_library.php_stream_filter_register_factory_volatile = ['int', ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.php_stream_filter_factory)]];
_library._functions.push(_library.php_stream_filter_register_factory_volatile);

_library.php_stream_filter_create = [ref.refType(_library.php_stream_filter), ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.zval), 'int']];
