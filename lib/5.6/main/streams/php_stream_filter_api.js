...
_library.php_stream_bucket_split = ['int', [_library.php_stream_bucket ? ref.refType(_library.php_stream_bucket) : 'pointer', _library.php_stream_bucket ? ref.refType(_library.php_stream_bucket) : 'pointer' ? ref.refType(_library.php_stream_bucket ? ref.refType(_library.php_stream_bucket) : 'pointer') : 'pointer', _library.php_stream_bucket ? ref.refType(_library.php_stream_bucket) : 'pointer' ? ref.refType(_library.php_stream_bucket ? ref.refType(_library.php_stream_bucket) : 'pointer') : 'pointer', 'ulong']];
