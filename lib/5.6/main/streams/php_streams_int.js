...
_library.php_stream_mode_sanitize_fdopen_fopencookie = ['void', [ref.refType(_library.php_stream), 'char' ? ref.refType('char') : 'pointer']];
...
_library.php_stream_display_wrapper_errors = ['void', [ref.refType(_library.php_stream_wrapper), 'char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer']];
