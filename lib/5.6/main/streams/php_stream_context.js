...
_library.php_stream_context_get_option = ['int', [_library.php_stream_context ? ref.refType(_library.php_stream_context) : 'pointer', ref.refType('char'), ref.refType('char'), ref.refType(ref.refType(_library.zval ? ref.refType(_library.zval) : 'pointer'))]];
