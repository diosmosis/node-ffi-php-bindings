...
_library._arg_separators.size = 1;

_library._preload['_arg_separators'] = [function () {
    _library._arg_separators.size = 0;
...
_library._preload['arg_separators'] = [function () {
    _library.arg_separators = _library._arg_separators;
}];

_library._php_core_globals = Struct({});
_library._php_core_globals.size = 1;

_library._preload['_php_core_globals'] = ['arg_separators', '_arg_separators', 'pointer', 'HashTable', '_hashtable', 'zend_llist', '_zend_llist', function () {
    _library._php_core_globals.size = 0;
    _library._php_core_globals.defineProperty("activated_auto_globals", _library.__RefArray('uchar', 8));
    ...
    _library._php_core_globals.defineProperty("http_globals", _library.__RefArray(ref.refType(_library.zval), 6));
...
_library._preload['php_core_globals'] = [function () {
