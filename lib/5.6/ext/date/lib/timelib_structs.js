...
_library.timelib_tzinfo = Struct({
    "bc": 'uchar',
    "charcnt": 'uint',
    "leap_times": _library.tlinfo ? ref.refType(_library.tlinfo) : 'pointer',
    "leapcnt": 'uint',
    ...
    "ttisgmtcnt": 'uint',
    "ttisstdcnt": 'uint',
    "type": _library.ttinfo ? ref.refType(_library.ttinfo) : 'pointer',
    "typecnt": 'uint'
});
...
_library.timelib_time = Struct({
    ...
    "tz_info": _library.timelib_tzinfo ? ref.refType(_library.timelib_tzinfo) : 'pointer',
    "y": 'longlong',
    "z": 'int',
    "zone_type": 'uint'
});
...
_library.timelib_error_container = Struct({
    "error_count": 'int',
    "error_messages": _library.timelib_error_message ? ref.refType(_library.timelib_error_message) : 'pointer',
    "warning_count": 'int',
    "warning_messages": _library.timelib_error_message ? ref.refType(_library.timelib_error_message) : 'pointer'
});
...
_library._timelib_tzdb = Struct({
    ...
    "index": _library.timelib_tzdb_index_entry ? ref.refType(_library.timelib_tzdb_index_entry) : 'pointer',
    "index_size": 'int',
