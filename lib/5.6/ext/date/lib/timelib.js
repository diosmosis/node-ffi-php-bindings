...
_library.timelib_tz_get_wrapper = ffi.Function(ref.refType(_library.timelib_tzinfo), ['char' ? ref.refType('char') : 'pointer', ref.refType(_library._timelib_tzdb)]);
...
_library.timelib_isoweek_from_date = ['void', ['longlong', 'longlong', 'longlong', 'longlong' ? ref.refType('longlong') : 'pointer', 'longlong' ? ref.refType('longlong') : 'pointer']];
...
_library.timelib_strtotime = [ref.refType(_library.timelib_time), ['char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library.timelib_error_container) ? ref.refType(ref.refType(_library.timelib_error_container)) : 'pointer', ref.refType(_library.timelib_tzdb), _library.timelib_tz_get_wrapper]];
_library._functions.push(_library.timelib_strtotime);

_library.timelib_parse_from_format = [ref.refType(_library.timelib_time), ['char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library.timelib_error_container) ? ref.refType(ref.refType(_library.timelib_error_container)) : 'pointer', ref.refType(_library.timelib_tzdb), _library.timelib_tz_get_wrapper]];
...
_library.timelib_timezone_id_from_abbr = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer', 'long', 'int']];
...
_library.timelib_parse_tz_cor = ['long', ['char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer']];
_library._functions.push(_library.timelib_parse_tz_cor);

_library.timelib_strtointerval = ['void', ['char' ? ref.refType('char') : 'pointer', 'int', ref.refType(_library.timelib_time) ? ref.refType(ref.refType(_library.timelib_time)) : 'pointer', ref.refType(_library.timelib_time) ? ref.refType(ref.refType(_library.timelib_time)) : 'pointer', ref.refType(_library.timelib_rel_time) ? ref.refType(ref.refType(_library.timelib_rel_time)) : 'pointer', 'int' ? ref.refType('int') : 'pointer', ref.refType(_library.timelib_error_container) ? ref.refType(ref.refType(_library.timelib_error_container)) : 'pointer']];
...
_library.timelib_timezone_id_is_valid = ['int', ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.timelib_tzdb)]];
_library._functions.push(_library.timelib_timezone_id_is_valid);

_library.timelib_parse_tzfile = [ref.refType(_library.timelib_tzinfo), ['char' ? ref.refType('char') : 'pointer', ref.refType(_library.timelib_tzdb)]];
...
_library.timelib_timezone_builtin_identifiers_list = [ref.refType(_library.timelib_tzdb_index_entry), ['int' ? ref.refType('int') : 'pointer']];
_library._functions.push(_library.timelib_timezone_builtin_identifiers_list);

_library.timelib_parse_zone = ['long', ['char' ? ref.refType('char') : 'pointer' ? ref.refType('char' ? ref.refType('char') : 'pointer') : 'pointer', 'int' ? ref.refType('int') : 'pointer', ref.refType(_library.timelib_time), 'int' ? ref.refType('int') : 'pointer', ref.refType(_library.timelib_tzdb), _library.timelib_tz_get_wrapper]];
_library._functions.push(_library.timelib_parse_zone);

_library.timelib_tzinfo_ctor = [ref.refType(_library.timelib_tzinfo), ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.timelib_tzinfo_ctor);

_library.timelib_time_tz_abbr_update = ['void', [ref.refType(_library.timelib_time), 'char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.timelib_time_tz_abbr_update);

_library.timelib_time_tz_name_update = ['void', [ref.refType(_library.timelib_time), 'char' ? ref.refType('char') : 'pointer']];
...
_library.timelib_time_set_option = ['void', [ref.refType(_library.timelib_time), 'int', 'void' ? ref.refType('void') : 'pointer']];
...
_library.timelib_date_to_int = ['long', [ref.refType(_library.timelib_time), 'int' ? ref.refType('int') : 'pointer']];
...
_library.timelib_decimal_hour_to_hms = ['void', ['double', 'int' ? ref.refType('int') : 'pointer', 'int' ? ref.refType('int') : 'pointer', 'int' ? ref.refType('int') : 'pointer']];
...
_library.timelib_astro_rise_set_altitude = ['int', [ref.refType(_library.timelib_time), 'double', 'double', 'double', 'int', 'double' ? ref.refType('double') : 'pointer', 'double' ? ref.refType('double') : 'pointer', 'longlong' ? ref.refType('longlong') : 'pointer', 'longlong' ? ref.refType('longlong') : 'pointer', 'longlong' ? ref.refType('longlong') : 'pointer']];
