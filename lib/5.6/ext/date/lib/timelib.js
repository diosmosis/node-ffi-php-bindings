...
_library._functions['timelib_day_of_week'] = _library.timelib_day_of_week;

_library.timelib_iso_day_of_week = ['longlong', ['longlong', 'longlong', 'longlong']];
_library._functions['timelib_iso_day_of_week'] = _library.timelib_iso_day_of_week;

_library.timelib_day_of_year = ['longlong', ['longlong', 'longlong', 'longlong']];
_library._functions['timelib_day_of_year'] = _library.timelib_day_of_year;

_library.timelib_daynr_from_weeknr = ['longlong', ['longlong', 'longlong', 'longlong']];
_library._functions['timelib_daynr_from_weeknr'] = _library.timelib_daynr_from_weeknr;

_library.timelib_days_in_month = ['longlong', ['longlong', 'longlong']];
_library._functions['timelib_days_in_month'] = _library.timelib_days_in_month;

_library.timelib_isoweek_from_date = ['void', ['longlong', 'longlong', 'longlong', ref.refType('longlong'), ref.refType('longlong')]];
_library._functions['timelib_isoweek_from_date'] = _library.timelib_isoweek_from_date;

_library.timelib_valid_time = ['int', ['longlong', 'longlong', 'longlong']];
_library._functions['timelib_valid_time'] = _library.timelib_valid_time;

_library.timelib_valid_date = ['int', ['longlong', 'longlong', 'longlong']];
_library._functions['timelib_valid_date'] = _library.timelib_valid_date;
...
_library._functions['timelib_strtotime'] = _library.timelib_strtotime;
...
_library._functions['timelib_parse_from_format'] = _library.timelib_parse_from_format;

_library.timelib_fill_holes = ['void', [ref.refType(_library.timelib_time), ref.refType(_library.timelib_time), 'int']];
_library._functions['timelib_fill_holes'] = _library.timelib_fill_holes;

_library.timelib_timezone_id_from_abbr = [ref.refType('char'), [ref.refType('char'), 'long', 'int']];
_library._functions['timelib_timezone_id_from_abbr'] = _library.timelib_timezone_id_from_abbr;

_library.timelib_timezone_abbreviations_list = [ref.refType(_library.timelib_tz_lookup_table), []];
_library._functions['timelib_timezone_abbreviations_list'] = _library.timelib_timezone_abbreviations_list;

_library.timelib_parse_tz_cor = ['long', [ref.refType(ref.refType('char'))]];
_library._functions['timelib_parse_tz_cor'] = _library.timelib_parse_tz_cor;
...
_library._functions['timelib_get_time_zone_info'] = _library.timelib_get_time_zone_info;

_library.timelib_get_current_offset = ['longlong', [ref.refType(_library.timelib_time)]];
_library._functions['timelib_get_current_offset'] = _library.timelib_get_current_offset;

_library.timelib_dump_tzinfo = ['void', [ref.refType(_library.timelib_tzinfo)]];
_library._functions['timelib_dump_tzinfo'] = _library.timelib_dump_tzinfo;

_library.timelib_builtin_db = [ref.refType(_library.timelib_tzdb), []];
_library._functions['timelib_builtin_db'] = _library.timelib_builtin_db;

_library.timelib_timezone_builtin_identifiers_list = [ref.refType(_library.timelib_tzdb_index_entry), [ref.refType('int')]];
_library._functions['timelib_timezone_builtin_identifiers_list'] = _library.timelib_timezone_builtin_identifiers_list;
...
_library._functions['timelib_astro_rise_set_altitude'] = _library.timelib_astro_rise_set_altitude;
...
_library._functions['timelib_diff'] = _library.timelib_diff;
...
_library._functions['timelib_add'] = _library.timelib_add;
...
_library._functions['timelib_sub'] = _library.timelib_sub;
