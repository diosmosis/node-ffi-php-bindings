...
_library._preload['_php_date_obj'] = ['HashTable', 'zend_object', '_zend_object', 'timelib_time', function () {
...
_library._preload['_php_timezone_obj'] = ['HashTable', 'zend_object', '_zend_object', 'timelib_tzinfo', 'timelib_abbr_info', 'timelib_abbr_info', function () {
...
_library._preload['_php_interval_obj'] = ['timelib_rel_time', 'HashTable', 'zend_object', '_zend_object', function () {
...
_library._preload['_php_period_obj'] = ['timelib_time', 'timelib_time', 'timelib_rel_time', 'timelib_time', 'zend_class_entry', 'zend_object', '_zend_object', function () {
...
_library._preload['_zend_date_globals'] = ['timelib_error_container', 'HashTable', function () {
