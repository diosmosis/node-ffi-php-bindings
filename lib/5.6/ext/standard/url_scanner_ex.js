...
_library.php_url_scanner_adapt_single_url = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer', 'ulong', 'char' ? ref.refType('char') : 'pointer', 'char' ? ref.refType('char') : 'pointer', 'ulong' ? ref.refType('ulong') : 'pointer']];
_library._functions.push(_library.php_url_scanner_adapt_single_url);

_library.php_url_scanner_add_var = ['int', ['char' ? ref.refType('char') : 'pointer', 'int', 'char' ? ref.refType('char') : 'pointer', 'int', 'int']];
...
_library.url_adapt_state_ex_t = Struct({
    ...
    "lookup_data": 'char' ? ref.refType('char') : 'pointer',
