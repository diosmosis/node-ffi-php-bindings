...
_library.zif_phpversion = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_phpversion);

_library.zif_phpinfo = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_phpinfo);

_library.zif_phpcredits = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_phpcredits);

_library.zif_php_sapi_name = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_php_sapi_name);

_library.zif_php_uname = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_php_uname);

_library.zif_php_ini_scanned_files = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_php_ini_scanned_files);

_library.zif_php_ini_loaded_file = ['void', ['int', ref.refType(_library.zval), ref.refType(_library.zval) ? ref.refType(ref.refType(_library.zval)) : 'pointer', ref.refType(_library.zval), 'int']];
_library._functions.push(_library.zif_php_ini_loaded_file);

_library.php_info_html_esc = ['char' ? ref.refType('char') : 'pointer', ['char' ? ref.refType('char') : 'pointer']];
_library._functions.push(_library.php_info_html_esc);

_library.php_info_html_esc_write = ['void', ['char' ? ref.refType('char') : 'pointer', 'int']];
...
_library.php_info_print_table_colspan_header = ['void', ['int', 'char' ? ref.refType('char') : 'pointer']];
...
_library.php_get_uname = ['char' ? ref.refType('char') : 'pointer', ['char']];
